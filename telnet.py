...
def olt_onu_viewer(sn,olt_name_ip,command='0',card=0,port=0,vport=0):
    ...
    if olt_name_ip in korch_olt :
        USER='логин для специфических оптических железок'
        PSWD='пароль для специфических оптических железок'
    else:
        USER="логин для типовых оптических железок"
        PSWD="пароль для типовых оптических железок"
